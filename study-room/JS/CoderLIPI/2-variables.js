...
Source: https://kotakode.com/blogs/10214/Mengenal-Perbedaan-LET%2C-CONST%2C-Dan-VAR-Pada-Javascript
...
/*
RULE 2: USE 'let' AS MINIMUM AS POSSIBLE ONLY WHEN NEEDED. Use 'const' by default everywhere because 'const' means constant so its prevents variable re-assignment.
...
2. CAN CONTAIN LETTERS / NUMBERS / DOLLAR SIGN / DOLLAR SIGN ($) / UNDERSCORE (_) BUT NO OTHER SPECIAL CHARACTERS AND NO SPACE.
...
console.log(employeeName + ' live in '  + employeeAddress); // output will be -> Bob live in New York
...
let EmployeeAddress = 'California street 222'; // intent to assign first employee address. Bad practice, will be pretty hard to notice the difference
// an IDEAL camel case example
let firstEmployeeAddress = 'New York'; // intent to assign first employee address
let secondEmployeeAddress = 'California street 222'; // intent to assign first employee address. Better practice, will be easier to notice the difference
